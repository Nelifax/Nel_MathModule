...
def class_test(class_name:str='Rational', report_mode:str='full')->None:
    '''
    ...
    '''
    if report_mode not in ['full', 'short']: report_mode='full'
    print(f'Starting a test for {class_name} class with report_mode:{report_mode}')
    print('------------------------------------')
    match(class_name):
        case 'Fraction':
