...
def matrices_base_test(reportType:str='full'):
    ...
    if reportType == 'full':
        ...
        tests = [
            ...
            [(Matrix('1,2,2,3').invert()*4).values, [[4,8],[8,12]], f'(2x2 square matrix)*4 test', 'multiply'],
            [(Matrix('1,2,2,3,3,4,1,1,1').invert()*2).values, [[2,4,4],[6,6,8],[2,2,2]], f'(3x3 square matrix)*2 test', 'multiply'],                 
